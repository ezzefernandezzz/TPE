...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2021 a las 21:53:28
...
INSERT INTO `comentarios` (`id_comentario`, `comentario`, `puntuacion`, `id_contenido`, `id_usuario`) VALUES
(1, 'Comentario dea', '3', 4, 25),
(3, 'Aguante Friends.-', '5', 1, 25),
(4, 'Na mentira, friends es malisimo.', '1', 1, 23),
(16, ' fasfa', '3', 1, 1),
(25, 'A la grande le puse cuca', '5', 4, 1);
...
INSERT INTO `usuarios` (`id_usuario`, `nombreUsuario`, `password`, `administrador`) VALUES
(1, 'eze', '$2y$10$mapSntRhoyRkWRTznsfTguysNy1HCbeVcBqBzm2B3X1m6mjlju8gy', 1),
(4, 'ezee', '$2y$10$g0vrHNRNKPuNiNnT8fG7uuu.2OkqYFjpcGjrliXgof32A2pmEIDbi', 0),
(5, 'ezeee', '$2y$10$A/snRSGVp1tVJzMjFZI.z.9VFHZnCmvr1jqTRXpefbBmoXzBrio8y', 0),
(18, 'elpepe', '$2y$10$Oqr8bb6XNQF1QK.P0SDAxOvNGNT4k1jAjnW45A.RDtFfXruq21aVe', 0),
(19, 'elpepa', '$2y$10$Ri2w22e5LKt4Ea0Ge9gAMu2s755QdDG.KctYwd6Cbst1TayylQPYi', 0),
(21, 'belenenemark@gmail.c', '$2y$10$L4t.dYX2lzylKhNYFla5.eZDBOMM3bnknrruHbOXBkFg8M7ncvibG', 1),
(22, 'sonmalos@gmail.com', '$2y$10$fmVlKEz4hPyok.zq6dYpYO9cPBD9ifH5ygXkuqc80mRG1tsUjyG5u', 0),
(23, 'ezekiel1', '$2y$10$EhoAlNA525QO75SWBv82u.ZE2F.NBR3vFjesUB1Yh.63qai6mNB3a', 0),
(24, 'prueba', '$2y$10$KAI1F5Z4EoWHlgTUuhfxhuc7McQhY7lmNviQn/Y1ApPAvCIym46Ma', 0),
(25, 'Alfajor', '$2y$10$2AMHj8OKyWNiigLNNGk.OuLwhspAwMWcNV2jNFf2RfakaOwrG/0Hu', 1);
...
ALTER TABLE `comentarios`
  ...
  ADD KEY `fk_id_contenido` (`id_contenido`),
...
--
ALTER TABLE `contenido`
  MODIFY `id_contenido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
ALTER TABLE `comentarios`
  ...
  ADD CONSTRAINT `comentarios_ibfk_3` FOREIGN KEY (`id_contenido`) REFERENCES `contenido` (`id_contenido`) ON DELETE CASCADE ON UPDATE CASCADE;
